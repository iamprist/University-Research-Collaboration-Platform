...
{showErrorModal && (
    ...
    {dropdownVisible && (
      ...
      searchResults.map(item => (
        ...
        <Box sx={{ maxWidth: 1200, mx: 'auto' }}>
          <Typography variant="h4" sx={{ mb: 3 }}>Your Research</Typography>
  ...
  <Typography variant="h4" sx={{ mb: 3 }}>Collaboration Requests</Typography>
  <Paper sx={{ p: 3, bgcolor: '#132238', borderRadius: 2 }}>
    <CollaborationRequestsPanel userId={userId} />
        ...
        <Box sx={{ mt: 6, maxWidth: 1200, mx: 'auto' }}>
          <Typography variant="h4" sx={{ mb: 3 }}>Your Collaborations</Typography>
          <Grid container spacing={3}>

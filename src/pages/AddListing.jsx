...
function AddListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/researcher-dashboard'); // Redirect to Researcher Dashboard
    } catch (err) {
  ...
  const styles = {
    outerContainer: {
      backgroundColor: '#132238', // Dark blue-gray for the outer background
      minHeight: '100vh',
      display: 'flex',
      alignItems: 'center',
    ...
    header: {
      textAlign: 'center',
      marginBottom: '2rem',
      color: '#132238', // Dark blue-gray for text
    },
    form: {
      display: 'grid',
    ...
    label: {
      ...
      marginBottom: '0.5rem',
      display: 'block',
      color: '#132238', // Dark blue-gray for labels
    },
    input: {
      width: '100%',
      padding: '0.75rem',
      ...
      fontSize: '1rem',
      color: '#132238', // Dark blue-gray for input text
    },
    textarea: {
      width: '100%',
      padding: '0.75rem',
    ...
    button: {
      backgroundColor: '#64CCC5', // Vibrant teal for primary button
      color: '#FFFFFF',
